...
/**
* iterate_wild - Iterates through a string located at
...
/**
* postfix_match - Checks if a string str matches the
...
* Return: If the strings can be considered identical return 1 else 0
*/
int wildcmp(char *s1, char *s2)
{
if (*s2 == '*')
